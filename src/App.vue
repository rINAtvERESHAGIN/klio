<template>
  <div id="app">
    ...
    <footer>
      <b-container fluid>
        <b-row>
          <b-col cols="12" md="4" lg="4" xl="4" order="3" order-lg="2" order-xl="1">
          ...
          <b-col cols="12" md="6" xl="5" order="1" class="mb-md-5">
          ...
          <b-col cols="12" md="3" lg="3" xl="3" order="2" order-lg="3"
            ...
            <p>
              <a v-for="social in SOCIALS" :key="social.id" :href="social.url"><img :src="social.img" :alt="social.name"
                                                                                    class="social-icon"></a>
            </p>
          </b-col>
        </b-row>
...
export default {
  ...
  components: {
    Login: () => import('../src/components/k-login.vue'),
    TopSubHeader: () => import('./App/components/TopSubHeader/TopSubHeader'),
    BurgerMenuButton: () => import('./App/components/BurgerMenuButton'),
