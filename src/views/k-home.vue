      ...
      <b-col cols="12" :xl="LEFT_MENU === false ? 12 : 9" id="content-area">
        ...
        <div class="blk-width-85 product-list" id="specials">
          ...
          <client-only>
            ...
            <p v-else-if="LOADING_PRODUCTS_SPECIAL_MAIN === 'empty'"
               style="margin: 30px 0 60px 0">
              К сожалению, в настоящий момент данный раздел пуст.</p>
          </client-only>
        </div>
        ...
        <div class="blk-width-85 product-list" id="new-products">
          ...
          <client-only>
            ...
            <p v-else-if="LOADING_PRODUCTS_NEW_MAIN === 'empty'" style="margin: 30px 0 60px 0">
              К сожалению, в настоящий момент данный раздел пуст.</p>
          </client-only>
        </div>
        ...
        <div class="blk-width-85 brand-list" id="brands">
          ...
          <client-only>
            ...
            <p v-else-if="LOADING_BRANDS === 'empty'"
               style="margin: 30px 0 60px 0"
            >К сожалению, в настоящий момент данный раздел пуст.</p>
          </client-only>
        </div>
